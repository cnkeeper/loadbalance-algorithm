 ...
 * @since 1.0
 */
public class Murmur2HashFunction implements HashFunction<String> {
    /**
     * The murmur seed to be used
     */
    private static final long DEFAULT_MURMUR_SEED = 0x7f3a21eaL;
    ...
    public Long hash(String key) {
        return hash(key.getBytes(DEFAULT_CHARSET), DEFAULT_MURMUR_SEED);
    }
}
